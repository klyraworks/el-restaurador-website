...
export default function ServiciosPage() {
    ...
    async function handleSave() {
        ...
        const montoPendiente = form.monto_pendiente === "" ? montoTotal : parseFloat(form.monto_pendiente) || 0;
        const estadoFinal = montoPendiente === 0 ? "pagado" : "pendiente";

        const body = {
            tricimoto_num: form.tricimoto_num,
            tricimoto_color: form.tricimoto_color,
            descripcion: form.descripcion,
            monto_total: montoTotal,
            monto_pendiente: montoPendiente,
            mecanico_id: parseInt(form.mecanico_id),
            estado: selected ? form.estado : estadoFinal,
    ...
    return (
      ...
      `}</style>
            ...
            <div style={{padding: "32px 28px 60px"}}>
                ...
                {/* Tabla */}
                <div
                    style={{background: "#fff", border: "1px solid #E4E4E7", borderRadius: "14px", overflow: "hidden"}}>
