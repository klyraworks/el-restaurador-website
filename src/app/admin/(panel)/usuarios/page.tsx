        ...
        <div style={{display: "flex", alignItems: "center", gap: "10px"}}>
            <button
                ...
                style={{
                    ...
                    padding: "2px",
                    flexShrink: 0,
                    background: checked ? "#10121A" : "#E4E4E7",
                ...
                <div style={{
                    ...
                    <div>
                        ...
                        <p style={{
                            ...
                            color: "#A1A1AA",
                            marginTop: "3px"
                        }}>{rows.length > 0 ? `${rows.length} usuarios registrados` : "Mecánicos y administradores del sistema"}</p>
                    </div>
                    <button onClick={openCreate} className="btn-primary" style={S.primary}><IconPlus/> Nuevo usuario
                    </button>
                </div>
                        ...
                        {loading ? (
                            ...
                            <tr>
                                <td colSpan={6} style={{padding: "56px", textAlign: "center"}}>
                                    <p style={{fontSize: "13px", color: "#A1A1AA", marginBottom: "12px"}}>Sin usuarios
                                        registrados</p>
                            ...
                            return (
                                <tr key={u.id} onMouseEnter={() => setHoveredRow(u.id)}
                                    ...
                                    <td style={S.td}>
                                      <span style={{
                                        ...
                                        <span style={{
                                            ...
                                            height: "5px",
                                            borderRadius: "50%",
                                            background: u.is_active ? "#22C55E" : "#A1A1AA",
                                            flexShrink: 0
                                        }}/>
                                    ...
                                    <td style={S.td}>
                                        <div style={{
                                            ...
                                            <button onClick={() => openEdit(u)} className="ra-edit"><IconEdit/> Editar
                                            </button>
                                            <button onClick={() => {
                                                setSelected(u);
                                                setModal("delete");
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <h2 style={{
                                ...
                                fontWeight: 700,
                                color: "#10121A"
                            }}>{selected ? "Editar usuario" : "Nuevo usuario"}</h2>
                        ...
                        <div style={{padding: "20px 24px", display: "flex", flexDirection: "column", gap: "14px"}}>
                            ...
                            <div style={{display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px"}}>
                                <div>
                                    ...
                                    <FocusInput type="number" value={form.telegram_id}
                                                onChange={e => setForm(f => ({...f, telegram_id: e.target.value}))}
                                                placeholder="123456789"/>
                                </div>
                                <div>
                                    <label style={S.label}>Username</label>
                                    <FocusInput value={form.username}
                            ...
                            <div>
                                <label
                                    style={S.label}>{selected ? "Nueva contraseña (dejar vacío para no cambiar)" : "Contraseña"}</label>
                                <FocusInput type="password" value={form.password}
                                            onChange={e => setForm(f => ({...f, password: e.target.value}))}
                                            placeholder="••••••••"/>
                            </div>
                            {selected && (
                                <Toggle checked={form.is_active} onChange={v => setForm(f => ({...f, is_active: v}))}
                                        label="Usuario activo" id="is_active"/>
                            )}
                        </div>
                        <div style={{
                            padding: "16px 24px",
                    ...
                    <div style={{
                        ...
                        <div style={{padding: "20px 24px", display: "flex", gap: "14px", alignItems: "flex-start"}}>
                            ...
                            <p style={{fontSize: "13px", color: "#3F3F46", lineHeight: "1.65"}}>
                                ¿Eliminar al usuario <strong style={{color: "#10121A"}}>{selected.nombre}</strong>? Esta
