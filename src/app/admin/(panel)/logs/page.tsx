            ...
            <div style={{padding: "32px 28px 60px"}}>
                ...
                <div style={{marginBottom: "24px"}}>
                    ...
                    <p style={{
                        ...
                        color: "#A1A1AA",
                        marginTop: "3px"
                    }}>{total > 0 ? `${total} eventos registrados` : "Registro de actividad del sistema"}</p>
                </div>
                ...
                <div style={{display: "flex", gap: "8px", marginBottom: "16px", alignItems: "center"}}>
                    ...
                    <div style={{width: "180px"}}>
                        <FocusSelect value={filtroTabla} onChange={e => {
                    ...
                    <div style={{overflowX: "auto", WebkitOverflowScrolling: "touch"}}>
                        <table style={{width: "100%", borderCollapse: "collapse"}}>
                            ...
                            <tr style={{borderBottom: "1px solid #E4E4E7", background: "#FAFAFA"}}>
                                {["#", "Acción", "Tabla / Registro", "Detalle", "Usuario", "Fecha"].map(h => <th key={h}
                                                                                                                 style={S.th}>{h}</th>)}
                            </tr>
                            </thead>
                            <tbody>
                            {loading ? (
                                ...
                                const ac = ACCION_STYLE[l.accion] ?? {
                                    bg: "#F4F4F5",
                                    color: "#71717A",
                                    border: "#E4E4E7",
                                    dot: "#A1A1AA"
                                };
                                const fecha = new Date(l.created_at).toLocaleDateString("es-EC", {
                                    day: "2-digit",
                                    month: "short",
                                    year: "numeric"
                                });
                                const hora = new Date(l.created_at).toLocaleTimeString("es-EC", {
                                    hour: "2-digit",
                                    minute: "2-digit"
                                });
                                const isHovered = hoveredRow === l.id;
                                return (
                                    <tr key={l.id} onMouseEnter={() => setHoveredRow(l.id)}
                        ...
                        <span style={{
                          ...
                          {l.accion}
                                        ...
                                        <td style={{
                                            ...
                                            {fecha}
                                            <span
                                                style={{display: "block", opacity: 0.6, marginTop: "1px"}}>{hora}</span>
                                        </td>
                                    </tr>
                                );
                            })}
