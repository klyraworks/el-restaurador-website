...
const TARIFAS: {
  ...
  { nombre: "Limpieza de magneto",            precio: 7  },
  { nombre: "Engrasado de motor de arranque", precio: 10 },
  { nombre: "Calibración de válvulas",        precio: 3  },
  { nombre: "Reparación de cilindro",         precio: 35 },
  { nombre: "Reparación de la corona",        precio: 25 },
  { nombre: "Reparación completa del motor",  precio: 90 },
  // ── Frenos
  ...
  { nombre: "Cambio de cañería posterior",     precio: 3 },
  { nombre: "Cambio de cañería central",       precio: 5 },
  { nombre: "Cambio de cable de freno de mano", precio: 4 },
  // ── Transmisión y embrague
  { nombre: "Cambio de cables de marcha", precio: 2 },
  { nombre: "Cambio de cable de embrague", precio: 2 },
  ...
  { nombre: "Cambio de bocines del trapecio",        precio: 5  },
  { nombre: "Cambio de bocín del amortiguador delantero", precio: 2 },
  { nombre: "Cambio de amortiguador delantero",      precio: 4  },
  { nombre: "Cambio de amortiguadores posteriores",  precio: 3  },
  { nombre: "Cambio de pistas",                      precio: 8  },
  { nombre: "Engrasada de brazo o palier",           precio: 4  },
  // ── Carrocería
  { nombre: "Cambio de parabrisas TVS",   precio: 10 },
  { nombre: "Cambio de parabrisas Bajaj", precio: 15 },
  // ── Mantenimiento general
  {
    nombre: "Mantenimiento completo TVS",
    precio: 40,
  ...
  {
    nombre: "Mantenimiento completo BAJAJ",
    precio: 35,
    nota: "Los siguientes trabajos son adicionales:",
    detalle: [
      { label: "Cambio de pin",                    valor: 5, adicional: true },
